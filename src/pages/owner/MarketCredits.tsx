...
import { CreditCard, Plus, User, Phone, DollarSign, Calendar, Search } from 'lucide-react';
...
export default function MarketCredits() {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<MarketCreditFormData>();
  ...
  const calculateCustomerBalance = (customerPhone: string) => {
    const customerCredits = marketCredits.filter(credit => credit.customerPhone === customerPhone);
  ...
  const getTotalOutstanding = () => {
    return marketCredits.reduce((sum, credit) => sum + parseNumber(credit.amount), 0);
  };
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              >
                ...
                <span>{processing ? 'Adding...' : 'Add Credit Entry'}</span>
              </button>
            </form>
          </div>
              ...
              {selectedCustomer && (
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 max-h-40 overflow-y-auto">
                    ...
                    {marketCredits
                      .filter(credit => credit.customerPhone === selectedCustomer)
                      .slice(0, 5)
                      .map((credit) => (
